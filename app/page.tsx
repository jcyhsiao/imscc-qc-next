...
import { Button, Divider, Flex, Grid, FileTrigger, Link, Heading, View } from '@adobe/react-spectrum';
  ...
  return (
    ...
    <View margin='auto' width='90vw'>
      <Grid columns={['1fr']} gap='size-200' justifyItems={'center'}>
        ...
        <p>Upload an IMSCC 1.1 archive to perform quality checks.</p>
        <p>To try this out, download a sample imscc. Here is an example from Canvas Commons: <Link href='https://drive.google.com/file/d/1gkWnmA4RdjFOP1_xBSibah0mQjxEA_Qs/view?usp=sharing'>Growing with Canvas
          by Education Services</Link> (<Link href='https://lor.instructure.com/resources/149d663e5b6a4fd0940b5fbd8fc45e56?shared'>see on Canvas Commons</Link>)</p>
        <Flex gap='size-100'>
          <FileTrigger
            onSelect={(e) => {
